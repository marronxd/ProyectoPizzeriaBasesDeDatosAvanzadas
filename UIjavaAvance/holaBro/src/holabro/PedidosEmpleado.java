...
public class PedidosEmpleado {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            nombre.setBounds(50, 30, 400, 100);
            ...
            JPanel fila1 = crearFilaPedido("Aaron", "15/02/26", 0);
            listaPedidos.add(fila1);

            JPanel fila2 = crearFilaPedido("Aaron 2", "15/02/26", 110);
            listaPedidos.add(fila2);
            
            JPanel fila3 = crearFilaPedido("Aaron 3", "16/02/26", 220);
            listaPedidos.add(fila3);
